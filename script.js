...
function showRyojiChapter(chapter) {
    updateDialogue('ryojiDialogueContent', ryojiStories[chapter]);
...
function showYukihoChapter(chapter) {
    updateDialogue('yukihoDialogueContent', yukihoStories[chapter]);
...
function showSasagakiChapter(chapter) {
    updateDialogue('sasagakiDialogueContent', sasagakiStories[chapter]);
